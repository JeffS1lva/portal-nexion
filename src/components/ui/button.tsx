    ...
    variants: {
      variant: {
        ...
        bottomTrucker:
          ...
          ButtonStatus:
          "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 flex items-end ml-auto cursor-pointer",
        secondary:
